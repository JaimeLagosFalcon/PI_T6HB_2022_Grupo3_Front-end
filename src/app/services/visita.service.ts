...
export class VisitaService {
  ...
  listaVisita(dni:string, coddepartamento:number, estado:number):Observable<any>{
    const params = new HttpParams().set("dni", dni).set("coddepartamento", coddepartamento).set("estado", estado);
